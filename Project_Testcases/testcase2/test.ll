; ModuleID = '/home/swapnil7/test/testcase2/test.ll'
source_filename = "/home/swapnil7/test/testcase2/testcase2.c"
...
entry:
  ...
  %tmp = load i8*, i8** %a, align 8
  %call1 = call i32 @puts(i8* %tmp)
  ret void
}
